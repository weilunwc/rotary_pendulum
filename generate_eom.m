...
eom1 = (Mp*Lr^2+Mp*Lp^2/4-Mp*Lp^2*cos(pi-alpha)^2/4+Jr)*theta_ddot...
      -(Mp*Lp*Lr*cos(pi-alpha)/2)*alpha_ddot+(Mp*Lp^2*sin(pi-alpha)*cos(pi-alpha))*theta_dot*alpha_dot...
      +(Mp*Lp*Lr*sin(pi-alpha)/2)*alpha_dot^2 == tau - Dr*theta_dot;
eom2 = Mp*Lp*Lr*cos(pi-alpha)/2*theta_ddot+(Jp+Mp*Lp^2/4)*alpha_ddot-Mp*Lp^2*cos(pi-alpha)*sin(pi-alpha)*theta_dot^2/4 ...
      +Mp*Lp*g*sin(pi-alpha)/2 == -Dp*alpha_dot;
